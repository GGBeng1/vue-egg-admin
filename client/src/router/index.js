      ...
      children: [
        {
          ...
          component: () =>
            import(
              /* webpackChunkName: "table" */ "@/view/homePage/components/main"
            ),
          children: [
            {
              path: "tableExport",
              ...
              component: () =>
                import(
                  /* webpackChunkName: "tableExport" */ "@/view/table/tableExport"
                )
            },
            {
              path: "tableUpload",
              ...
              component: () =>
                import(
                  /* webpackChunkName: "tableUpload" */ "@/view/table/tableUpload"
                )
            }
          ]
        }
